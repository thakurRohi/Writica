...
// import { updateProfileName } from "../store/profileSlice";
...
//   const { user, updateStatus, updateError } = useSelector((state) => state.profile);
...
//     try {
//       await dispatch(updateProfileName(formData.name)).unwrap();
//       // You can add more profile update actions here
//       navigate('/');
//     } catch (error) {
